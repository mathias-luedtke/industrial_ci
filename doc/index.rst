...
* **TARGET_WORKSPACE** (default: not set): Definition of extra sources for target `workspace <#workspace-management>`__.
...
B. Target workspace: Packages in your target repository that should get build and tested
   ...
   1. Fetch addtional source code (``TARGET_WORKSPACE``)
   2. Install dependencies with ``rosdep``
