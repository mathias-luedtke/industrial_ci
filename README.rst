...
This package contains `CI (Continuous Integration) <https://en.wikipedia.org/wiki/Continuous_integration>`__ configuration that any ROS-powered packages can commonly use.
